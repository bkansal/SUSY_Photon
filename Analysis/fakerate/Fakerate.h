...
class Fakerate : public NtupleVariables{
 ...
 public:
  ...
  vector<double> QMultLowedge_v2={0,2,4,7,30};
  vector<double> QMultLowedge_v3={0,2,100};
  ...
  TH2D *h2_PhoPtQMultJet_scale[12];
  TH2D *h2_PhoPtQMultJet_v2_scale[12];
  TH2D *h2_PhoPtQMultJet_pdf[112];
  TH2D *h2_PhoPtQMultJet_v2_pdf[112];
  TH2D *h2_PhoPtnJets;
  ...
  TH2D *h2_PhoPtQMultJet_fr[55];  
  TH1D *h2_PhoPtQMultJet_SF[55];
  TH1D *h_nvtx_elec0;
  TH1D *h_ST_elec0;
  TH1D *h_MET_elec0;
  ...
  TH1D *h_hadAk8Mass_EW_elec0;
  TH1D *h_hadAk8Mass_SP_elec0;
   TH1D *h_CM_Pho;
  TH1D *h_EMObj_pT_elec0;
 TH2D *h2_PhoPtQMultJet_elec0;
 TH2D *h2_PhoPtQMultJet_v2_elec0;
 TH2D *h2_PhoPtQMultJet_scale_elec0[12];
 TH2D *h2_PhoPtQMultJet_v2_scale_elec0[12];
 TH2D *h2_PhoPtQMultJet_pdf_elec0[112];
 TH2D *h2_PhoPtQMultJet_v2_pdf_elec0[112];
  ...
  TH1D *h_hadAk8Mass_EW_elec1_closure;
  TH1D *h_hadAk8Mass_SP_elec1_closure;
  TH1D *h_ST_SP_elec1_closure;
  TH1D *h_MET_SP_elec1_closure;
  TH1D *h_BTags_SP_elec1_closure;
  TH1D *h_BestPhotonPt_SP_elec1_closure;
  TH1D *h_nJets_SP_elec1_closure;
  TH1D *h_ST_EW_elec1_closure;
  TH1D *h_MET_EW_elec1_closure;
  TH1D *h_BTags_EW_elec1_closure;
  TH1D *h_BestPhotonPt_EW_elec1_closure;
  TH1D *h_nJets_EW_elec1_closure;
  ...
  TH2D *h2_MET_dPhiMETj1_elec1_closure;
  TH2D *h2_MET_dPhiMETj2_elec1_closure;
  TH2D *h2_MET_dPhiMETj_elec1_closure;
  ...
  TH1D *h_hadAk8jetPt_EW_elec1_closure;
  TH1D *h_hadAk8jetPt_SP_elec1_closure;
  ...
  TH2D *h2_PhoPtQMultJet_scale_elec1_closure[12];
  TH2D *h2_PhoPtQMultJet_v2_scale_elec1_closure[12];
  TH2D *h2_PhoPtQMultJet_pdf_elec1_closure[112];
  TH2D *h2_PhoPtQMultJet_v2_pdf_elec1_closure[112];
  ...
  TH2D *h2_SBins_v6_CD_EW_50bin_elec1_closure;
  TH2D *h2_SBins_v6_CD_EW_50bin_elec1;
  TH2D *h2_SBins_v6_CD_EW_50bin_elec0;
...
void Fakerate::BookHistogram(const char *outFileName) {
  ...
  h_pass_events = new TH1F("pass_events","pass or fail events",12,-0.5,12.5);
  ...
  h_SclWt = new TH1D("SclWt","Scale weights, no selection",10,0,10);
  h_PDFWt = new TH1D("PDFWt","PDF weights, no selection",110,0,110);
  ...
  h_DBTags=new TH1D("nDBTags","no. of B jets -B tags",10,0,10);
  ...
  h2_PhoPtQMultJet_v2=new TH2D("PhoPtQMultJet_v2","x: Photon Pt vs charged multiplicity in the matching jet",ptlow2.size()-1,&(ptlow2[0]),QMultLowedge_v2.size()-1,&(QMultLowedge_v2[0]));
  char* sname = new char[200];
  for(int i=0; i<12; i++){
    sprintf(sname,"PhoPtQMultJet_scale_%d",i);
    h2_PhoPtQMultJet_scale[i]=new TH2D(sname,"x: Photon Pt vs charged multiplicity in the matching jet",ptlow2.size()-1,&(ptlow2[0]),QMultLowedge.size()-1,&(QMultLowedge[0]));
    sprintf(sname,"PhoPtQMultJet_v2_scale_%d",i);
    h2_PhoPtQMultJet_v2_scale[i]=new TH2D(sname,"x: Photon Pt vs charged multiplicity in the matching jet",ptlow2.size()-1,&(ptlow2[0]),QMultLowedge_v2.size()-1,&(QMultLowedge_v2[0]));
  }
  for(int i=0; i<112; i++){
    sprintf(sname,"PhoPtQMultJet_pdf_%d",i);
    h2_PhoPtQMultJet_pdf[i]=new TH2D(sname,"x: Photon Pt vs charged multiplicity in the matching jet",ptlow2.size()-1,&(ptlow2[0]),QMultLowedge.size()-1,&(QMultLowedge[0]));
    sprintf(sname,"PhoPtQMultJet_v2_pdf_%d",i);
    h2_PhoPtQMultJet_v2_pdf[i]=new TH2D(sname,"x: Photon Pt vs charged multiplicity in the matching jet",ptlow2.size()-1,&(ptlow2[0]),QMultLowedge_v2.size()-1,&(QMultLowedge_v2[0]));
  }

  for(int i=1; i<55; i++){
    sprintf(sname,"PhoPtQMultJet_fr_%d",i); 
    h2_PhoPtQMultJet_fr[i]=new TH2D(sname,"x: Photon Pt vs charged multiplicity in the matching jet",ptlow2.size()-1,&(ptlow2[0]),QMultLowedge.size()-1,&(QMultLowedge[0]));
    sprintf(sname,"PhoPtQMultJet_SF_%d",i);
    h2_PhoPtQMultJet_SF[i]=new TH1D(sname,"charged multiplicity in the matching jet",QMultLowedge_v3.size()-1,&(QMultLowedge_v3[0]));
  }	
  ...
  h_DBTags_elec0=new TH1D("nDBTags_elec0","no. of B jets - B tags",10,0,10);
  ...
  h_hadAk8Mass_EW_elec0=new TH1D("hadAk8Mass_EW_elec0","Soft dropped mass of AK8 Jet",1000,0,300);
  h_hadAk8Mass_SP_elec0=new TH1D("hadAk8Mass_SP_elec0","Soft dropped mass of AK8 Jet",1000,0,300);
  ...
  for(int i=0; i<12; i++){
    sprintf(sname,"PhoPtQMultJet_scale_elec0_%d",i);
    h2_PhoPtQMultJet_scale_elec0[i]=new TH2D(sname,"x: Photon Pt vs charged multiplicity in the matching jet",ptlow2.size()-1,&(ptlow2[0]),QMultLowedge.size()-1,&(QMultLowedge[0]));
    sprintf(sname,"PhoPtQMultJet_v2_scale_elec0_%d",i);
    h2_PhoPtQMultJet_v2_scale_elec0[i]=new TH2D(sname,"x: Photon Pt vs charged multiplicity in the matching jet",ptlow2.size()-1,&(ptlow2[0]),QMultLowedge_v2.size()-1,&(QMultLowedge_v2[0]));
    sprintf(sname,"PhoPtQMultJet_scale_elec1_closure_%d",i);
    h2_PhoPtQMultJet_scale_elec1_closure[i]=new TH2D(sname,"x: Photon Pt vs charged multiplicity in the matching jet",ptlow2.size()-1,&(ptlow2[0]),QMultLowedge.size()-1,&(QMultLowedge[0]));
    sprintf(sname,"PhoPtQMultJet_v2_scale_elec1_closure_%d",i);
    h2_PhoPtQMultJet_v2_scale_elec1_closure[i]=new TH2D(sname,"x: Photon Pt vs charged multiplicity in the matching jet",ptlow2.size()-1,&(ptlow2[0]),QMultLowedge_v2.size()-1,&(QMultLowedge_v2[0]));

  }
  for(int i=0; i<112; i++){
    sprintf(sname,"PhoPtQMultJet_pdf_elec0_%d",i);
    h2_PhoPtQMultJet_pdf_elec0[i]=new TH2D(sname,"x: Photon Pt vs charged multiplicity in the matching jet",ptlow2.size()-1,&(ptlow2[0]),QMultLowedge.size()-1,&(QMultLowedge[0]));
    sprintf(sname,"PhoPtQMultJet_v2_pdf_elec0_%d",i);
    h2_PhoPtQMultJet_v2_pdf_elec0[i]=new TH2D(sname,"x: Photon Pt vs charged multiplicity in the matching jet",ptlow2.size()-1,&(ptlow2[0]),QMultLowedge_v2.size()-1,&(QMultLowedge_v2[0]));

    sprintf(sname,"PhoPtQMultJet_pdf_elec1_closure_%d",i);
    h2_PhoPtQMultJet_pdf_elec1_closure[i]=new TH2D(sname,"x: Photon Pt vs charged multiplicity in the matching jet",ptlow2.size()-1,&(ptlow2[0]),QMultLowedge.size()-1,&(QMultLowedge[0]));
    sprintf(sname,"PhoPtQMultJet_v2_pdf_elec1_closure_%d",i);
    h2_PhoPtQMultJet_v2_pdf_elec1_closure[i]=new TH2D(sname,"x: Photon Pt vs charged multiplicity in the matching jet",ptlow2.size()-1,&(ptlow2[0]),QMultLowedge_v2.size()-1,&(QMultLowedge_v2[0]));
 ...
 //  h2_PhoPtQMultJet_elec0=new TH2D("PhoPtQMultJet_elec0","x: Photon Pt vs charged multiplicity in the matching jet",300,0,1500,25,0,25);
  ...
  h2_PhoPtQMultJet_v2_elec0=new TH2D("PhoPtQMultJet_v2_elec0","x: Photon Pt vs charged multiplicity in the matching jet",ptlow2.size()-1,&(ptlow2[0]),QMultLowedge_v2.size()-1,&(QMultLowedge_v2[0]));
  ...
  h_ST_SP_elec1_closure=new TH1D("ST_SP_elec1_closure","ST",400,0,4000);
  h_MET_SP_elec1_closure=new TH1D("MET_SP_elec1_closure","MET",200,0,2000);
  h_BTags_SP_elec1_closure=new TH1D("nBTags_SP_elec1_closure","no. of B tags",10,0,10);
  h_nJets_SP_elec1_closure=new TH1D("nJets_SP_elec1_closure","nJets",25,0,25);
  h_BestPhotonPt_SP_elec1_closure=new TH1D("BestPhotonPt_SP_elec1_closure","Pt of the Best Photon",300,0,1500);
  h_ST_EW_elec1_closure=new TH1D("ST_EW_elec1_closure","ST",400,0,4000);
  h_MET_EW_elec1_closure=new TH1D("MET_EW_elec1_closure","MET",200,0,2000);
  h_BTags_EW_elec1_closure=new TH1D("nBTags_EW_elec1_closure","no. of B tags",10,0,10);
  h_nJets_EW_elec1_closure=new TH1D("nJets_EW_elec1_closure","nJets",25,0,25);
  h_BestPhotonPt_EW_elec1_closure=new TH1D("BestPhotonPt_EW_elec1_closure","Pt of the Best Photon",300,0,1500);
  ...
  h_DBTags_elec1_closure=new TH1D("nDBTags_elec1_closure","no. of B jets - B tags",10,0,10);
  ...
  h2_MET_dPhiMETj1_elec1_closure=new TH2D("MET_dPhiMETj1_elec1_closure","MET vs dPhi(MET, J1)",300,0,1500,200, 0, 4);
  h2_MET_dPhiMETj2_elec1_closure=new TH2D("MET_dPhiMETj2_elec1_closure","MET vs dPhi(MET, J2)",300,0,1500,200, 0, 4);
  h2_MET_dPhiMETj_elec1_closure=new TH2D("MET_dPhiMETj_elec1_closure","MET vs mindPhi(MET, J)",300,0,1500,200, 0, 4);
  ...
  h_hadAk8jetPt_EW_elec1_closure=new TH1D("hadAk8jetPt_EW_elec1_closure","Soft dropped Pt of AK8 Jet",2000,0,1000);
  h_hadAk8jetPt_SP_elec1_closure=new TH1D("hadAk8jetPt_SP_elec1_closure","Soft dropped Pt of AK8 Jet",2000,0,1000);
  h_hadAk8Mass_elec1_closure=new TH1D("hadAk8Mass_elec1_closure","Soft dropped mass of AK8 Jet",1000,0,300);
  h_hadAk8Mass_EW_elec1_closure=new TH1D("hadAk8Mass_EW_elec1_closure","Soft dropped mass of AK8 Jet",1000,0,300);
  h_hadAk8Mass_SP_elec1_closure=new TH1D("hadAk8Mass_SP_elec1_closure","Soft dropped mass of AK8 Jet",1000,0,300);
  ...
  h2_PhoPtQMultJet_v2_elec1_closure=new TH2D("PhoPtQMultJet_v2_elec1_closure","x: Photon Pt vs charged multiplicity in the matching jet",ptlow2.size()-1,&(ptlow2[0]),QMultLowedge_v2.size()-1,&(QMultLowedge_v2[0]));
  ...
  h2_mindr_lep_goodph_ph=new TH2D("h_mindr_lep_goodph_ph","Mindr b/w gen lepton and good Photon (x axis) vs p_{T}^{#gamma}/p_{T}^{gen l} (y axis)",500,0,5,5000,0,50);
 ...
 h_SBins_v6_CD_EW_7bin_noSB = new TH1D("AllSBins_v6_CD_EW_7bin_noSB","search bins v6:[(WTag : [65,105])]",7,0.5,7.5);
  ...
  // h_SBins_v6_CD_EW_50bin_elec1 = new TH1D("AllSBins_v6_CD_EW_50bin_elec1","search bins v6:[(WTag : [65,105]),(HTag : [105,140])]",51,0.5,51.5);
   h2_SBins_v6_CD_EW_50bin_elec0 = new TH2D("h2_AllSBins_v6_CD_EW_50bin_elec0","search bins v6:[(WTag : [65,105]),(HTag : [105,140])]",52,0,52,50,0,50);
   h2_SBins_v6_CD_EW_50bin_elec1_closure = new TH2D("h2_AllSBins_v6_CD_EW_50bin_elec1_closure","search bins v6:[(WTag : [65,105]),(HTag : [105,140])]",52,0,52,50,0,50);
   h2_SBins_v6_CD_EW_50bin_elec1 = new TH2D("h2_AllSBins_v6_CD_EW_50bin_elec1","search bins v6:[(WTag : [65,105]),(HTag : [105,140])]",52,0,52,50,0,50);
