...
class Lostlepton : public NtupleVariables{
 ...
 public:
  ...
  int getBinNoV7_le3(bool,bool,bool,bool,int,int);
  ...
  TH1D *h_mindr_lep_goodph_elec0;
  TH1D *h_hasGenPromptPhoton_elec0;
  TH1D *h_hasGenPromptPhoton;
  TH1D *h_hasGenPromptPhoton_ele_elec0;
  TH1D *h_hasGenPromptPhoton_ele;

  TH2D *h2_mindr_lep;
  TH2D *h2_mindr_lep_goodele_ele;
  TH2D *h2_mindr_lep_goodph_ph;
  TH2D *h2_mindr_mu_goodph_ph;
  TH2D *h2_mindr_lep_goodph_ph_elec0;
  TH2D *h2_mindr_mu_goodph_ph_elec0;
  TH2D *h2_mindr_genjete_genjetpho;
  TH1D *h_mindr_genph_lep;
  TH1D *h_mindr_genph_lep_elec0;
  ...
  TH1D *h_SBins_v6_CD_elec0_hadtau;
  TH1D *h_SBins_v6_CD_elec1_acc;
  TH1D *h_SBins_v6_CD_elec1_tot;
  TH1D *h_SBins_v6_CD_elec1_id;
  TH1D *h_SBins_v6_CD_elec1_iso;
  TH1D *h_SBins_v6_CD_elec1_hadtau;
  ...
  TH2D *h_SBins_v7_CD_SP_scale_elec0;
  TH2D *h_SBins_v7_CD_SP_pdf_elec0;
  TH2D *h_SBins_v7_CD_SP_scale_elec1;
  TH2D *h_SBins_v7_CD_SP_pdf_elec1;
...
void Lostlepton::BookHistogram(const char *outFileName) {
  ...
  h_DBTags_elec0=new TH1D("nDBTags_elec0","no. of Bjets - B tags",10,0,10);
  ...
  h_mTlepMET_elec0=new TH1D("mTlepMET_elec0","mT b/w bestPhoton and MET",200,0,2000);
  ...
  h_mTlepMET_elec1_closure=new TH1D("mTlepMET_elec1_closure","mT b/w bestPhoton and MET",200,0,2000);
  ...
  h_mTlepMET=new TH1D("mTlepMET","mT b/w bestPhoton and MET",200,0,2000);
  ...
  h_hasGenPromptPhoton_ele_elec0= new TH1D("hasGenPromptPhoton_ele_elec0","hasGenPromptPhoton",4,-2,2);
  h_hasGenPromptPhoton_ele= new TH1D("hasGenPromptPhoton_ele","hasGenPromptPhoton",4,-2,2);
  h_hasGenPromptPhoton_elec0= new TH1D("hasGenPromptPhoton_elec0","hasGenPromptPhoton",4,-2,2);
  h_hasGenPromptPhoton= new TH1D("hasGenPromptPhoton","hasGenPromptPhoton",4,-2,2);
  h2_mindr_lep=new TH2D("h_mindr_lep","Mindr b/w gen Electron and good Photon (x axis) vs Mindr b/w gen Electron and good Electron (y axis)",500,0,5,500,0,5);
  h2_mindr_lep_goodph_ph=new TH2D("h_mindr_lep_goodph_ph","Mindr b/w gen Electron and good Photon (x axis) vs p_{T}^{gen l}/p_{T}^{#gamma} (y axis)",500,0,5,5000,0,50);
  h2_mindr_mu_goodph_ph=new TH2D("h_mindr_mu_goodph_ph","Mindr b/w gen Muon and good Photon (x axis) vs p_{T}^{gen l}/p_{T}^{#gamma} (y axis)",500,0,5,5000,0,50);
  h2_mindr_lep_goodph_ph_elec0=new TH2D("h_mindr_lep_goodph_ph_elec0","Mindr b/w gen Electron and good Photon (x axis) vs p_{T}^{gen l}/p_{T}^{#gamma} (y axis)",500,0,5,5000,0,50);
  h2_mindr_mu_goodph_ph_elec0=new TH2D("h_mindr_mu_goodph_ph_elec0","Mindr b/w gen Muon and good Photon (x axis) vs p_{T}^{gen l}/p_{T}^{#gamma} (y axis)",500,0,5,5000,0,50);
  h2_mindr_lep_goodele_ele=new TH2D("h_mindr_lep_goodele_ele","Mindr b/w gen Electron and good Electron (x axis) vs p_{T}^{gen e}/p_{T}^{e} (y axis)",500,0,5,5000,0,50);
  h2_mindr_genjete_genjetpho=new TH2D("h2_mindr_genjete_genjetpho","Mindr b/w gen jet and good Photon (x axis) vs Mindr b/w gen jet and good Electron (y axis)",500,0,5,500,0,5);

  h_mindr_lep_goodph=new TH1D("h_mindr_lep_goodph","Mindr b/w gen lepton and good Photon ",500,0,5);
  h_mindr_lep_goodph_elec0=new TH1D("h_mindr_lep_goodph_elec0","Mindr b/w gen lepton and good Photon ",500,0,5);
  ...
  h_mindr_genph_lep_elec0=new TH1D("h_mindr_genph_lep_elec0","Mindr b/w gen Photon and gen lepton ",500,0,5);
  ...
  h_mindr_goodph_ph=new TH1D("h_mindr_goodph_ph","Mindr b/w good elec and gen elec",500,0,5);
 ...
 h_SBins_v6_CD_EW_7bin_noSB = new TH1D("AllSBins_v6_CD_EW_7bin_noSB","search bins v6:[(WTag : [65,105])]",7,0.5,7.5);
  ...
  h_SBins_v7_1_CD_elec0 = new TH1D("AllSBins_v7_1_CD_elec0","search bins v7:[0b,1b] x [(NJ=2to4),(NJ:5or6),(NJ>=7)]_CD",4,1,5);
  h_SBins_v7_1_CD_elec1 = new TH1D("AllSBins_v7_1_CD_elec1","search bins v7:[0b,1b] x [(NJ=2to4),(NJ:5or6),(NJ>=7)]_CD",4,1,5);
  ...
  h_SBins_v6_CD_elec0_hadtau = new TH1D("AllSBins_v6_CD_elec0_hadtau","search bins v6:[0b,1b] x [(NJ=2to4),(NJ:5or6),(NJ>=7)]_CD",8,1,9);
  h_SBins_v6_CD_elec1_acc = new TH1D("AllSBins_v6_CD_elec1_acc","search bins v6:[0b,1b] x [(NJ=2to4),(NJ:5or6),(NJ>=7)]_CD",8,1,9);
  h_SBins_v6_CD_elec1_id = new TH1D("AllSBins_v6_CD_elec1_id","search bins v6:[0b,1b] x [(NJ=2to4),(NJ:5or6),(NJ>=7)]_CD",8,1,9);
  h_SBins_v6_CD_elec1_iso = new TH1D("AllSBins_v6_CD_elec1_iso","search bins v6:[0b,1b] x [(NJ=2to4),(NJ:5or6),(NJ>=7)]_CD",8,1,9);
  h_SBins_v6_CD_elec1_tot = new TH1D("AllSBins_v6_CD_elec1_tot","search bins v6:[0b,1b] x [(NJ=2to4),(NJ:5or6),(NJ>=7)]_CD",8,1,9);
  h_SBins_v6_CD_elec1_hadtau = new TH1D("AllSBins_v6_CD_elec1_hadtau","search bins v6:[0b,1b] x [(NJ=2to4),(NJ:5or6),(NJ>=7)]_CD",8,1,9);
...
",52,0,52);
  ...
  h_SBins_v7_CD_SP_scale_elec1 = new TH2D("AllSBins_v7_CD_SP_scale_elec1","search bins SP:[0b,1b] x [(NJ=2to4),(NJ:5or6),(NJ>=7)] + EW : Wtag & Htag",10,1,11,10,0,10);
  h_SBins_v7_CD_SP_scale_elec0 = new TH2D("AllSBins_v7_CD_SP_scale_elec0","search bins SP:[0b,1b] x [(NJ=2to4),(NJ:5or6),(NJ>=7)] + EW : Wtag & Htag",10,1,11,10,0,10);
  h_SBins_v7_CD_SP_pdf_elec1 = new TH2D("AllSBins_v7_CD_SP_pdf_elec1","search bins SP:[0b,1b] x [(NJ=2to4),(NJ:5or6),(NJ>=7)] + EW : Wtag & Htag",10,1,11,110,0,110);
  h_SBins_v7_CD_SP_pdf_elec0 = new TH2D("AllSBins_v7_CD_SP_pdf_elec0","search bins SP:[0b,1b] x [(NJ=2to4),(NJ:5or6),(NJ>=7)] + EW : Wtag & Htag",10,1,11,110,0,110);
  ...
  h_SBins_v6_CD_SP_elec0 = new TH1D("AllSBins_v6_CD_SP_elec0","search bins v6:[0b,1b] x [(NJ=2to4),(NJ:5or6),(NJ>=7)]_CD",4,1,5);
  h_SBins_v6_CD_SP_elec1 = new TH1D("AllSBins_v6_CD_SP_elec1","search bins v6:[0b,1b] x [(NJ=2to4),(NJ:5or6),(NJ>=7)]_CD",4,1,5);
