  ...
  if(do_prediction)
      ...
      if(!full_Run2)
	{
	  if(s_data.Contains("2016")){
	    TF = TFile::Open("Rfactor_lowMET_2016.root","READ");
            TF2 = TFile::Open("Kfactor_2016.root","READ");
            TF3 = TFile::Open("Kfactor_nbj0_2016.root","READ");
	  ...
	  if(s_data.Contains("2017")){       
	    TF = TFile::Open("Rfactor_2017.root","READ");
            TF2 = TFile::Open("Kfactor_2017.root","READ");
            TF3 = TFile::Open("Kfactor_nbj0_2017.root","READ");
	    tf=(TH1D*)TF->FindObjectAny("h3");
            tf2=(TH2D*)TF2->FindObjectAny("fr");
            tf3=(TH2D*)TF3->FindObjectAny("fr");
	  }
	  ...
	  if(s_data.Contains("2018")){
	    TF = TFile::Open("Rfactor_2018.root","READ");
            TF2 = TFile::Open("Kfactor_2018.root","READ");
            TF3 = TFile::Open("Kfactor_nbj0_2018.root","READ");
	    tf=(TH1D*)TF->FindObjectAny("h3");
            tf2=(TH2D*)TF2->FindObjectAny("fr");
            tf3=(TH2D*)TF3->FindObjectAny("fr");
	  }
      ...
      else
	{
	  ...
	  TF = TFile::Open("Rfactor_lowMET_data.root","READ");
	  //TF = TFile::Open("Rfactor_lowMET_MC.root","READ");
	  //	  TF = TFile::Open("RK_lowMET_data_MC.root","READ");  
      ...
      */
      ...
      tf=(TH1D*)TF->FindObjectAny("fr");
      TF2 = TFile::Open("btagSF/Kfactor.root","READ");                                                                             
      TF3 = TFile::Open("btagSF/Kfactor_nbj0.root","READ");                                                                        
      TF4 = TFile::Open("btagSF/Kfactor_Wtag.root","READ");                                                                        
      TF5 = TFile::Open("btagSF/Kfactor_Htag.root","READ");                            
      tf2=(TH2D*)TF2->FindObjectAny("fr");                                                                                  
      tf3=(TH2D*)TF3->FindObjectAny("fr");                                                                                  
      tf4=(TH1D*)TF4->FindObjectAny("h3");                                                                                  
      tf5=(TH1D*)TF5->FindObjectAny("h3");                                                                                  
...

  {
   ...
   if(region_B)
       ...
       if(EWselec && EWselec1)
	 {
       ...
       h_hadAk8Mass_B->Fill(Ak8Mass,wt2);
       if(hadAK8Jets.size() > 0) h_hadAk8jetPt_B->Fill(hadAK8Jets[0].Pt(),wt2);

       if((EWselec && EWselec1)) {
	 h_hadAk8Mass_EW_B->Fill(Ak8Mass,wt2);
	 if(hadAK8Jets.size() > 0) h_hadAk8jetPt_EW_B->Fill(hadAK8Jets[0].Pt(),wt2);
	 h_MET_EW_B->Fill(MET,wt2);
	 h_nJets_EW_B->Fill(nHadJets,wt2);
	 h_ST_EW_B->Fill(ST,wt2);
	 h_BestPhotonPt_EW_B->Fill(bestPhoton.Pt(),wt2);
	 h_BTags_EW_B->Fill(nbjets,wt2);

       }

       else
	 {
	   h_hadAk8Mass_SP_B->Fill(Ak8Mass,wt2);
	   if(hadAK8Jets.size() > 0)  h_hadAk8jetPt_SP_B->Fill(hadAK8Jets[0].Pt(),wt2);
	   h_MET_SP_B->Fill(MET,wt2);
	   h_nJets_SP_B->Fill(nHadJets,wt2);
	   h_ST_SP_B->Fill(ST,wt2);
	   h_BestPhotonPt_SP_B->Fill(bestPhoton.Pt(),wt2);
	   h_BTags_SP_B->Fill(nbjets,wt2);
	 }
