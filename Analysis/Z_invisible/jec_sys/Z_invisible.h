...
Z_invisible::Z_invisible(const TString &inputFileList, const char *outFileName, const char* dataset) {
  ...
  if(nameData=="elec_data_2016" || nameData=="elec_data_2017" || nameData=="elec_data_2018") tree = new TChain("PreSelection");
  if(nameData=="muon_data_2016" || nameData=="muon_data_2017" || nameData=="muon_data_2018") tree = new TChain("PreSelection");
