...
//void plotclosure_LL(TString varName="AllSBins_v7_CD_SP",  TString year="2016",  TString ntuples="v18" , bool ExpvsPred = true, bool SRvsCR=false)
  ...
  if(ntuples=="v18")
    {
      ...
      // path="rootoutput/closure/LL/";
      //path1="rootoutput/closure/LL/";
