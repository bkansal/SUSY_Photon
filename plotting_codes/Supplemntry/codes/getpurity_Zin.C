...
void getpurity_Zin(TString dir){
  ...
  */
  ...
  TCanvas *cA = new TCanvas("TrgEff","Trigger efficiency",1200,700);
  ...
  for(int i=0;i<nfiles;i++){
	...
	//	if(histName1[i]=="AllSBins_v6_CD_EW_7bin"  ){       
	  ...
	  TLatex Tl;
	  Tl.SetTextSize(0.04);
	  Tl.DrawLatex(1.25 ,1.25*50*yset_,"N_{b-tags} = 0");
          Tl.DrawLatex(2.25 ,1.25*50*yset_,"N_{b-tags} #geq 1");
