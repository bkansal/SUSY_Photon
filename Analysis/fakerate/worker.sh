...
xrdcp -f ${outname} root://cmseos.fnal.gov//store/user/bkansal/myProduction/Analysis/bkg_estimation/fakerate/${hist}/${outname}
xrdcp -f ${file} root://cmseos.fnal.gov//store/user/bkansal/myProduction/Analysis/bkg_estimation/fakerate/${hist}/${file}
rm ${outName}
rm ${file}
