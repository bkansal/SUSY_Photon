...
//void splitRunList(string infile,int nfPerJob, string datasetAna, string dir="LE/withoutJERC/"){
void splitRunList(string infile,int nfPerJob, string datasetAna, string dir="LE/withJERup/"){
  //------------ needed for condor files --------------
  string exeCondor  = "worker2.sh";
  string exeAna     = "lostlepton";
