...
void plotoverlay(TString varName="nJets",TString year="full_Run2", int rebin=5, TString path="rootoutput/rootfiles_MCcutflow_MET300/")
//void plotoverlay(TString varName="nJets",TString year="full_Run2", int rebin=1, TString path="rootoutput/nphotons/")
{
  ...
  if(varName=="METvBin")
      ...
      for(int i=0;i<nhist;i++)
	{
      ...
      */
      TString varName2_[9]={varName_nocut, varName_nolep,varName_noisotrack,varName_phopt,varName_MET200,varName_nj2,varName_ST300,varName_aftertrg,varName_dphi};
      TString Name_[9]={"No cut","0 Lepton","0 iso tracks","p_{T}^{#gamma} > 100 GeV"," p_{T}^{miss} > 300 GeV", "N_{jets} > 1","ST > 300 GeV","Trigger efficiency","min. #Delta #phi(jets,MET) > 0.3"};
