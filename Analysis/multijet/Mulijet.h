...
class Mulijet : public NtupleVariables{
 ...
 TH2D *h2_PhoPtQMultJet_v2_elec0;
  ...
  TH1D *h_BTags_EW_B;
  TH1D *h_nJets_EW_B;
  TH1D *h_BestPhotonPt_EW_B;
  TH1D *h_ST_SP_B;
  TH1D *h_MET_SP_B;
  TH1D *h_BTags_SP_B;
  TH1D *h_nJets_SP_B;
  TH1D *h_BestPhotonPt_SP_B;
  TH1D *h_hadAk8Mass_B;
  TH1D *h_hadAk8Mass_EW_B;
  TH1D *h_hadAk8Mass_SP_B;
  TH1D *h_hadAk8jetPt_B;
  TH1D *h_hadAk8jetPt_EW_B;
  TH1D *h_hadAk8jetPt_SP_B;
...
void Mulijet::BookHistogram(const char *outFileName) {
 ...
 //  h2_PhoPtQMultJet_elec0=new TH2D("PhoPtQMultJet_elec0","x: Photon Pt vs charged multiplicity in the matching jet",300,0,1500,25,0,25);
  ...
  h_hadAk8jetPt_B=new TH1D("hadAk8jetPt_B","Soft dropped Pt of AK8 Jet",2000,0,1000);
  h_hadAk8jetPt_EW_B=new TH1D("hadAk8jetPt_EW_B","Soft dropped Pt of AK8 Jet",2000,0,1000);
  h_hadAk8jetPt_SP_B=new TH1D("hadAk8jetPt_SP_B","Soft dropped Pt of AK8 Jet",2000,0,1000);
  h_hadAk8Mass_B=new TH1D("hadAk8Mass_B","Soft dropped mass of AK8 Jet",1000,0,300);
  h_hadAk8Mass_EW_B=new TH1D("hadAk8Mass_EW_B","Soft dropped mass of AK8 Jet",1000,0,300);
  h_hadAk8Mass_SP_B=new TH1D("hadAk8Mass_SP_B","Soft dropped mass of AK8 Jet",1000,0,300);
  h_ST_EW_B=new TH1D("ST_EW_B","ST",400,0,4000);
  h_MET_EW_B=new TH1D("MET_EW_B","MET",200,0,2000);
  h_nJets_EW_B=new TH1D("nJets_EW_B","nJets",25,0,25);
  h_BTags_EW_B=new TH1D("nBTags_EW_B","no. of B tags",10,0,10);
  h_BestPhotonPt_EW_B=new TH1D("BestPhotonPt_EW_B","Pt of the Best Photon",300,0,1500);
  h_ST_SP_B=new TH1D("ST_SP_B","ST",400,0,4000);
  h_MET_SP_B=new TH1D("MET_SP_B","MET",200,0,2000);
  h_nJets_SP_B=new TH1D("nJets_SP_B","nJets",25,0,25);
  h_BTags_SP_B=new TH1D("nBTags_SP_B","no. of B tags",10,0,10);
  h_BestPhotonPt_SP_B=new TH1D("BestPhotonPt_SP_B","Pt of the Best Photon",300,0,1500);
