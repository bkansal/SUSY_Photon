...
void plotdatavsMC_tmp(TString varName="AllSBins_v6_CD_EW_50bin",  TString year="full_Run2",  TString ntuples="v18" , bool ExpvsPred = false, bool SRvsCR=true)
{
  ...
  string lep="LL";
  TString path,path1;
  path="../fakerate/rootout/fake_rate_v10_dataMC_tmp/";
