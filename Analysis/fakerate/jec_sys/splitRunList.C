...
void splitRunList(string infile,int nfPerJob, string datasetAna, string dir="FR_SF/withJERup/"){
  //------------ needed for condor files --------------
  string exeCondor  = "worker2.sh";
  string exeAna     = "fakerate";
  //  string datasetAna = "SR";
  string filesToTransfer = "PileupHistograms_2016_69mb_pm5.root,PileupHistograms_2017_69mb_pm5.root,PileupHistograms_2018_69mb_pm5.root,fake_rate_2016_highdphi.root,fake_rate_2017_highdphi.root,fake_rate_2018_highdphi.root,fake_rate_2016_lowdphi.root,fake_rate_2017_lowdphi.root,fake_rate_2018_lowdphi.root,fake_rate_highdphi.root,fake_rate_lowdphi.root";
  //---------------------------------------------------
