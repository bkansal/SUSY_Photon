...
//void printRK_0pho( bool Kvalid=false,bool ExpvsPred=true,bool SRvsCR=false)
{
  ...
  */  
  ...
  Tl.DrawLatex(1.35,yset,"N^{ 0}_{ 2}");
  Tl.DrawLatex(2.35,yset,"N^{ 0}_{ 5-6}");
  ...
  TLegend *legend1 = new TLegend(0.7,0.78,0.89,0.89);
  ...
  intLumiE.DrawLatexNDC(0.75,0.92,"#bf{137 fb^{-1} (13 TeV)}");
