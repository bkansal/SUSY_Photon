void plotsys_LL(TString sys="default",TString year="full_Run2",int xmin=1,int xmax=11)
{
  // gStyle->SetOptStat(0);
  gStyle->SetPalette(1);
 ...
 if(sys=="drmodel")
   {
     path1="../lostlepton/rootoutput/new/nominal_fr/LE/";
     path2="../lostlepton/rootoutput/new/drpt3/LE_muo/";
   }
 else if(sys=="btagSF")
   {
     path1="../lostlepton/rootoutput/new/nominal_fr/LL/";
     path2="../lostlepton/rootoutput/new/bsfup/LL/";
     //     path2="../lostlepton/rootoutput/new/scalepdf/";

   }
  else if(sys=="JECup")
   {
     path1="../lostlepton/rootoutput/new/withoutjerc/LL/";
     path2="../lostlepton/rootoutput/new/withJEC/LL/";
   }
  else if(sys=="JERup")
   {
     path1="../lostlepton/rootoutput/new/withoutjerc/LL/";
     path2="../lostlepton/rootoutput/new/withJER/LL/";
   }
   else if(sys=="lepSF")
   {
     path1="../lostlepton/rootoutput/new/nominal_fr/LL/";
     path2="../lostlepton/rootoutput/new/esfup/LL/";
   }
   else if(sys=="scale")
   {

     //     path1="../lostlepton/rootoutput/newselec_LL_noISRjet_METfilters_EW_hadjetID_newPU_v18/TF_v7_usingfullRun2_BTagSF_SF_newBin2/";
     // path2="../lostlepton/rootoutput/newselec_LL_noISRjet_METfilters_EW_hadjetID_newPU_v18/TF_v7_usingfullRun2_BTagSF_SF_scalepdf_newBin2/";

     
     path1="../lostlepton/rootoutput/new/nominal_fr/LL/";
     path2="../lostlepton/rootoutput/new/scalepdf/LL/";     
 ...
 TString pdf = "pdf/LL_"+sys+".pdf";
 TString png = "png/LL_"+sys+".png";
 ...
 if(year == "full_Run2")
  ...
  if(sys == "scale" || sys == "pdf")
  ...
  else
    {
      ...
      textOnTop2.DrawLatexNDC(0.15,0.915," #it{#bf{Simulation Supplementary}}");

      double yset=(ymax_+ymin_)/1.66;
      cout<<"yset = "<<yset<<endl;

      TLine *line1V6=new TLine( 1,0,  1,0.7*ymax_);
      TLine *line2V6=new TLine( 2,0,  2,0.7*ymax_);
      TLine *line3V6=new TLine( 3,0,  3,0.7*ymax_);
      TLine *line4V6=new TLine( 4,0,  4,0.7*ymax_);
      TLine *line5V6=new TLine( 5,0,  5,0.7*ymax_);
      TLine *line6V6=new TLine( 6,0,  6,0.7*ymax_);
      TLine *line7V6=new TLine( 7,0,  7,0.7*ymax_);
      TLine *line8V6=new TLine( 8,0,  8,0.7*ymax_);
      TLine *line9V6=new TLine( 9,0,  9,0.7*ymax_);
      TLine *line10V6=new TLine( 10,0,  10,0.7*ymax_);
      ...
      Tl.DrawLatex(1.35,1.02*yset,"N^{ 0}_{ 2}");
      Tl.DrawLatex(2.35,1.02*yset,"N^{ 0}_{ 3}");
      Tl.DrawLatex(3.35,1.02*yset,"N^{ 0}_{ 4}");
      Tl.DrawLatex(4.25,1.02*yset,"N^{ 0}_{ 5-6}");
      Tl.DrawLatex(5.25,1.02*yset,"N^{ 0}_{ #geq7}");
      Tl.DrawLatex(6.25,1.02*yset,"N^{ #geq1}_{ 2-4}");
      Tl.DrawLatex(7.25,1.02*yset,"N^{ #geq1}_{ 5-6}");
      Tl.DrawLatex(8.25,1.02*yset,"N^{ #geq1}_{ #geq7}");
      Tl.DrawLatex(9.25,1.02*yset,"V tag");
      Tl.DrawLatex(10.25,1.02*yset,"H tag");
      //      T2.DrawLatex(4.5,yset*1.15,"SP region");
      //      T2.DrawLatex(9.5,yset*1.15,"EW region");
     

      
      TLegend *legend = new TLegend(0.12,0.83,0.35,0.89);
      ...
      TLegend *legend1 = new TLegend(0.75,0.78,0.89,0.89);
      legend1->SetBorderSize(0);
      legend1->AddEntry(sr1,"TF_{nominal}","lpe");
      legend1->AddEntry(sr2,"TF_{nominal + sys}","lpe");
     ...
     for(int i=0 ; i<xmax; i++)
	{
      ...
      pull->GetXaxis()->SetTitle("Bin index");
      ...
      line->Draw();
      //  sr2->Draw("same");
      TLine *line1V7=new TLine( 1,-0.09,  1,0.09);
      TLine *line2V7=new TLine( 2,-0.09,  2,0.09);
      TLine *line3V7=new TLine( 3,-0.09,  3,0.09);
      TLine *line4V7=new TLine( 4,-0.09,  4,0.09);
      TLine *line5V7=new TLine( 5,-0.09,  5,0.09);
      TLine *line6V7=new TLine( 6,-0.09,  6,0.09);
      TLine *line7V7=new TLine( 7,-0.09,  7,0.09);
      TLine *line8V7=new TLine( 8,-0.09,  8,0.09);
      TLine *line9V7=new TLine( 9,-0.09,  9,0.09);
      TLine *line10V7=new TLine( 10,-0.09,  10,0.09);
