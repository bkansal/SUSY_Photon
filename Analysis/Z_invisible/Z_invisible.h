...
class Z_invisible : public NtupleVariables{
 ...
 TH2D *h2_PhoPtQMultJet_v2_elec0;
  ...
  TH1D *h_SBins_v6_CD;
  TH2D *h_SBins_v6_CD_scale;
  TH2D *h_SBins_v6_CD_pdf;
  TH2D *h_SBins_v6_CD_scale_elec1_closure;
  TH2D *h_SBins_v6_CD_pdf_elec1_closure;

  TH1D *h_SBins_v6_CD_EW;
  TH1D *h_SBins_v6_CD_EW_htag;
  TH1D *h_SBins_v6_CD_SP;
  TH1D *h_SBins_v7_CD;
  TH1D *h_SBins_v7_CD_sf[55];
...
void Z_invisible::BookHistogram(const char *outFileName) {
  ...
  h2_BestPhotonEta_Phi=new TH2D("BestPhotonEta_Phi","BestPhoton Eta (x axis) vs Phi (yaxis)",200,-5,5,200,-5,5);
 ...
 //  h2_PhoPtQMultJet_elec0=new TH2D("PhoPtQMultJet_elec0","x: Photon Pt vs charged multiplicity in the matching jet",300,0,1500,25,0,25);
  ...
  h_SBins_v6_CD = new TH1D("AllSBins_v6_CD","search bins v6:[0b,1b] x [(NJ=2to4),(NJ:5or6),(NJ>=7)]_CD",4,1,5);

  h_SBins_v6_CD_scale = new TH2D("AllSBins_v6_CD_scale","search bins v6:[0b,1b] x [(NJ=2to4),(NJ:5or6),(NJ>=7)]_CD",4,1,5,11,0,11);
  h_SBins_v6_CD_pdf = new TH2D("AllSBins_v6_CD_pdf","search bins v6:[0b,1b] x [(NJ=2to4),(NJ:5or6),(NJ>=7)]_CD",4,1,5,111,0,111);
  h_SBins_v6_CD_scale_elec1_closure = new TH2D("AllSBins_v6_CD_scale_elec1_closure","search bins v6:[0b,1b] x [(NJ=2to4),(NJ:5or6),(NJ>=7)]_CD",4,1,5,11,0,11);
  h_SBins_v6_CD_pdf_elec1_closure = new TH2D("AllSBins_v6_CD_pdf_elec1_closure","search bins v6:[0b,1b] x [(NJ=2to4),(NJ:5or6),(NJ>=7)]_CD",4,1,5,111,0,111);
 ...
 h_SBins_v6_CD_EW_7bin_elec1_closure = new TH1D("AllSBins_v6_CD_EW_7bin_elec1_closure","search bins v6:[(WTag : [65,105])]",4,1,5);
  ...
  h_SBins_v7_CD = new TH1D("AllSBins_v7_CD","search bins v7:[0b,1b] x [(NJ=2to4),(NJ:5or6),(NJ>=7)]_CD",2,1,3);

  char* sname = new char[200];
  for(int i=1; i<55; i++){
    sprintf(sname,"AllSBins_v7_CD_sf_%d",i);
    h_SBins_v7_CD_sf[i] = new TH1D(sname,"search bins v7:[0b,1b] x [(NJ=2to4),(NJ:5or6),(NJ>=7)]_CD",2,1,3);
  }
