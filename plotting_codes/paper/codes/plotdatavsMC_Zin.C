...
void plotdatavsMC_Zin(TString varName,  TString year,  TString ntuples , bool ExpvsPred = true, bool SRvsCR=false)
{
 ...
 /*  cout<<"==============="<<endl; */
  ...
  hs_var->GetYaxis()->SetTitleSize(0.055);
  hs_var->GetYaxis()->SetTitleOffset(0.95);
  //  xmax_=1000;
  ...
  textOnTop.DrawLatexNDC(0.1,0.94,"CMS"); 
  textOnTop2.DrawLatexNDC(0.168,0.94,"#it{#bf{}}");
  if(year=="2016")
  ...
  if(year=="full_Run2")
    intLumiE.DrawLatexNDC(0.8,0.945,"#bf{137 fb^{-1} (13 TeV)}");
